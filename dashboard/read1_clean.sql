...
--
-- Host: localhost
-- Generation Time: Dec 16, 2025 (CLEANED VERSION)
-- Server version: 8.0.24
-- PHP Version: 8.3.25
-- 
-- ⚠️ CLEANED VERSION - Payment/Topup/History features removed
-- This database does NOT include:
-- ❌ transaction_history table
-- ❌ login_history table
-- ❌ ip_blacklist table
-- ❌ user_balance_transactions table
-- ❌ user_points_transactions table
-- ❌ users.balance, users.points columns
-- ❌ tools.price, tools.points_cost columns
...
-- ⚠️ CLEANED: Removed price and points_cost columns
--
...
-- ⚠️ CLEANED: Removed balance and points columns
--
