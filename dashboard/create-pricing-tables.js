...
async function createPricingTables() {
  try {
    ...
    const pricingPlansResult = await executeQuery(`
    ...
    console.log('Created pricing_plans table:', pricingPlansResult);
    ...
    console.log('Created user_subscriptions table:', subscriptionsResult);
    
    // Insert default pricing plans
    const insertPlans = await executeQuery(`
    ...
    console.log('Inserted default pricing plans:', insertPlans);
    
    // Check if tables were created successfully
    const checkPlans = await executeQuery('SELECT * FROM pricing_plans');
    console.log('Pricing plans:', checkPlans.data);
