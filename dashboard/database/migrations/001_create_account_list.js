...
export async function up() {
  ...
  console.log('✅ Created account_list and template_fields tables');
}

export async function down() {
  await executeQuery('DROP TABLE IF EXISTS template_fields');
  await executeQuery('DROP TABLE IF EXISTS account_list');
  console.log('✅ Dropped account_list and template_fields tables');
}
