...
import { getAndClearRegisteredUsername } from "utils/cookies";
...
export default function SignIn() {
  ...
  // Auto-fill username from URL parameter or cookie
  useEffect(() => {
    ...
    if (usernameFromUrl) {
      setValue('username', decodeURIComponent(usernameFromUrl));
      // Clean up URL
    ...
    // Check cookie for registered username
    const usernameFromCookie = getAndClearRegisteredUsername();
    if (usernameFromCookie) {
      setValue('username', usernameFromCookie);
    }
  }, [setValue]);
