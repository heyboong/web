...
export function MainPanel({ nav, setActiveSegment, activeSegment }) {
  ...
  return (
    <div className="main-panel">
      <div
        className={clsx(
          "flex h-full w-full flex-col items-center border-gray-150 bg-gradient-to-b from-white/80 via-white/60 to-white/40 backdrop-blur-xl dark:border-dark-600/80 ltr:border-r rtl:border-l",
          cardSkin === "shadow"
            ? "dark:from-dark-750/80 dark:via-dark-750/60 dark:to-dark-750/40"
            : "dark:from-dark-900/80 dark:via-dark-900/60 dark:to-dark-900/40",
        )}
      >
        {/* Application Logo */}
