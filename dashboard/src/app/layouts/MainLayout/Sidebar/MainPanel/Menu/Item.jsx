...
export function Item({
  ...
  return (
    <Element
      ...
      className={clsx(
        "relative flex size-11 shrink-0 cursor-pointer items-center justify-center rounded-xl outline-hidden transition-colors duration-200",
        isActive
          ? "bg-primary-600/10 text-primary-700 dark:bg-primary-400/15 dark:text-primary-300"
          : "text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 active:bg-gray-200 dark:text-dark-200 dark:hover:bg-dark-300/10 dark:hover:text-dark-50 dark:focus:bg-dark-300/10 dark:active:bg-dark-300/20",
      )}
