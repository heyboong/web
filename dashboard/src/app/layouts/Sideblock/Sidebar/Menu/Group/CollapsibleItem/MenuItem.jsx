  ...
  return (
    <div className="relative flex">
      <NavLink
        ...
        className={({ isActive }) =>
          clsx(
            "group min-w-0 flex-1 rounded-md px-3 py-1.5 text-[13px] font-medium outline-hidden transition-colors ease-in-out",
            isActive
        ...
        {({ isActive }) => (
          ...
          >
            ...
            {info && info.val && (
              <Badge
                color={info.color}
                className="h-5 min-w-[1.25rem] shrink-0 rounded-full px-1.5 text-[11px]"
              >
                {info.val}
              </Badge>
            )}
